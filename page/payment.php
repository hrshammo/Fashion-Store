            ...
            <div class="card-body p-0">
              <div class="row g-0">
               <div class="col-xl-12 bg-grey">
                  ...
                  <!--  <div class="mb-4 pb-2  h-10 " >
                      <select class="select">
                        <option value="1">COD - Cash On Delivery</option>
                        <option value="2">Bkash Payment(Currently Not available)</option>
                        <option value="3">Nogod Payment(Currently Not available)</option>
                        <option value="4">Bitcoin Payment(Currently Not available)</option>
                      </select>
                    </div>
    -->
